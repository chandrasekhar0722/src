...
SECRET_KEY = '=ippc%xqrnsw!i9tdm^g--fhd=8&cke9^cxx2c1oe#igs5u$e&'
...
if DEBUG:
	...
	MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR),"src", "media", "templates")
	STATICFILES_DIRS = (
	    os.path.join(os.path.dirname(BASE_DIR),"src", "static"),
)
